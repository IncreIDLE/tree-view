...
class TreeViewPackage {
  activate () {
    ...
    this.disposables.add(atom.commands.add('atom-workspace', {
      ...
      'tree-view:add-file': () => this.getTreeViewInstance().add(true, false),
      'tree-view:increidle-add-file': () => this.getTreeViewInstance().add(true, true), // Add another boolean for increidle modifications
      'tree-view:add-folder': () => this.getTreeViewInstance().add(false, false),
